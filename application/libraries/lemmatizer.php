...
class Lemmatizer {
    ...
    */
    ...
    /*
        Serves as a container for successful dictionary2 lookup
    ...
    */
    ...
    /*
        Tracks all the changes made to the jawab; The array is indexed by
        the general prefix form, such as di,ke,se,be,me,pe,te.

        for example, the jawab 'menapak' undergoes transformation men-tapak.
    ...
    */
    ...
    /*
        ...
        The conditions are:
            ...
            > 'lemma_not_found'     the lemmatizer fails to detect input jawab.
    ...
    */
    public function __construct() {
        ...
        $this->database = new PDO("mysql:host=localhost;dbname=db_ujianesai", "root", "");
    ...
    /*
        Checks the input jawab against the dictionary2; returns the jawab if found,
        or returns false if not found

        @param string $jawab
        @return mixed
    */
    protected function lookup($jawab) {

        // If the input jawab's length is smaller then 3, don't bother.
        if(strlen($jawab)<3) return false;


        /*
            Saves input jawab for further processing
        ...
        */
        ...
        /*
                ...
                Attempts to programatically split joined jawabs, in order to produce lemmas with
                more than one jawab. The split method only works when the first jawab contains 2 syllables.
        ...
        */
        if(strlen($jawab) <= 6) {
            ...
            // regex string for identifying the two jawabs.
            $reg = "/^(?<first>aneka|({$syllable}{$syllable}))(?<second>{$syllable}{$syllable}(?U)({$syllable})*)$/";
            
            if(preg_match($reg, $jawab, $match)) {
        ...
        /*
            ...
            If the checked jawab is ended with a vowel and the removed derivational suffix is -kan,
        ...
        */
        if(preg_match('/[aiueo]$/', $jawab) && $this->removed['derivational_suffix']=='kan' && strlen($jawab)>3) {
        ...
        /*
            ...
            @var PDO Object
        */
        $query = $this->database->query("SELECT * FROM dictionary2 WHERE lemma LIKE $query_string LIMIT 100");

        // updates total dictionary2 lookup counter
        $this->total_lookup++;
    ...
    /*
        Checks input jawab for rule precedence; If the input jawab has a confix:
        ...
        @return boolean
    */
    protected function check_rule_precedence($jawab) {
        ...
        */
        $patterns = array(
                0 => "/^be(?<jawab>{$alpha})([^k]an|lah|kah)$/",
                1 => "/^(me|di|pe|te)(?<jawab>{$alpha})(i)$/",
                2 => "/^(k|s)e(?<jawab>{$alpha})(i|kan)$/",
                3 => "/^([pm]e[nm]|di[tmp])(?<jawab>ah|ak|er|el)an$/"
            );

        /*

            Checks whether the input jawab matches the affix pairs above;
            returns true if pattern is found, and false if not found

        */
        foreach($patterns as $pattern) {

            if(preg_match($pattern, $jawab, $match) 
                && $match['jawab'] != 'ngalam') return true;
    ...
    /*
        Checks whether the input jawab contains disallowed affix pairs/confixes;
        returns true if the jawab has disallowed pair
    ...
    */
    ...
    /*
        ...
        from input jawab; Returns original value if no inflectional suffix found

        @param string $jawab
        @return string
    */
    protected function delete_inflectional_suffix($jawab) {
        ...
        */
        ...
        /*
            ...
            Checks whether the input jawab contains inflectional suffix, with
    ...
    /*
        Attempts to remove derivational suffixes -i, -kan, -an from input jawab;
        Returns original value if no derivational suffix found

        @param string $jawab
        @return string
    */
    protected function delete_derivational_suffix($jawab) {
        ...
        */
        ...
        /*
            ...
            Checks whether input jawab contains derivational suffix; before
        ...
        */
        if(preg_match($derivational_suffix, $result, $match)) {
            ...
            // Removes the derivational suffix from given jawab
    ...
    /*
        ...
        me-, pe- from input jawab. Generally, derivational prefix is divided to
        2 different group: 
            plain (di-, ke-, se-) and 
            complex (be-,me-,pe-,te-)

        Complex prefixes need transformation rules for certain cases in order to
        correctly lemmatize the input jawab.

        @param string $jawab
        @return mixed
    */
    protected function delete_derivational_prefix($jawab) {
        ...
        */
        ...
        /*
            ...
            A check is performed; if the input jawab has less than four characters,
        ...
        */
                ...
                if($type) {
                    ...
                    if($prefix == "be") {
                        ...
                        */
                        ...
                        /* 
                            ...
                            original input jawab will be returned. The previously
                    ...
                    *************************************************************************/
                        ...
                        /*
                            ...
                            already a removed prefix, immediately return input jawab.
                    ...
                    */
                    if($modification!=null) {
                        ...
                        // If there is no changes made, return original jawab.
                        return $result;
        ...
        // if no prefix found, return original jawab instead
        return $result;

    }

    /*
        Performs recoding on input jawab 
        (provided there are recoding paths available)

        @param string $jawab
        @return mixed
    */
    protected function recode($jawab) {
        ...
        */
        foreach($prefixes as $prefix => $changes) {
            ...
            */
            if($prefix_added!="") {
                ...
                // prepend the removed value to current jawab
            ...
            /*
                ...
                there are more than one path. For every path, the jawab is configured
            ...
            */ 
            if($recode!="") {
                ...
                /*
                    Temporary variable for storing jawab changes; used for checking
                    and lookup
                ...
                foreach($recode as $raw_removed => $added) {
                    ...
                    */
                    ...
                    /*
                        ...
                        Performs dictionary2 lookup. If found, this will return the lookup result,
                    ...
                    */
                    ...
                    for($i=0; $i<3; $i++) {
                        ...
                        /*
                            Temporary variable; holds the value before the jawab
        ...
        // If recoding is unsuccessful or does not exist, return initial jawab
        return $jawab;
    ...
    */
    public function eat($jawab, $backtrack_step = false) {
        ...
        */
        ...
        /*
            ...
            @var mixed
        */
        $temp = $this->lookup($jawab);

        /*
            
            STEP 1: perform dictionary2 lookup on input jawab
        ...
        */
        if($temp) {
            ...
            /*
                ...
                @var mixed
            */
            $steps = $this->check_rule_precedence($jawab);
            ...
            */
            ...
            /*
                ...
                STEP 8: if the dictionary2 lookup still fails, return original jawab.
                since the jawab was returned to its original form, removal histories
