...
class ujian_siswa extends CI_Controller {
	...
	//jika ada soal
			...
			$query2= "SELECT * FROM soal_ujian ORDER BY id_soal ASC LIMIT 1";
    ...
    {    
        ...
        $tanggal_terakhir = $this->db->query('SELECT * FROM hasil_ujian;');
        ...
        $ambil_id_soal= $this->db->query('SELECT DISTINCT id_soal FROM tf_idf;');
